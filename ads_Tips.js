//In built tips
 ...
 //Ads in buult
 let In_Built_Ads = `
        Ads_Img_S  https://drive.google.com/thumbnail?id=1VxQGzHp9IjIrapGtGyM  Ads_Img_E
        Ads_Url_S    https://uuu.wordpress.com  Ads_Url_E
        Ads_Alt_S   Ads 2  Ads_Alt_E
        Ads_Owner_S   Owner2  Ads_Owner_E


        Ads_Img_S  https://drive.google.com/thumbnail?id=1Vn6XI9j9nJ4zBTbkbBgz35 Ads_Img_E
        Ads_Url_S  HttpRequest Ads_Url_E
        Ads_Alt_S  Ads3 alt Ads_Alt_E
 ...
 */
 ...
 function displayTips() {
   ...
   if (Tips) {
     ...
     console.log(current_Tip.Author, current_Tip.Quoute);
     //displayTips
 ...
 function displayAds() {
   ...
   if (Ads) {
     ...
     CGPA_Ads.src = current_Ad.Img;
     CGPA_Ads.alt = current_Ad.Alt;
     CGPA_Ads.onclick = current_Ad.Url;
     
     GPA_Ads.src = current_Ad.Img;
     GPA_Ads.alt = current_Ad.Alt;
     CGPA_Ads.onclick = current_Ad.Url;
 ...
 Id("displayAds").addEventListener('click', () => {
   displayTips();
 })